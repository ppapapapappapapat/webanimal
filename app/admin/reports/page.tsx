...
const API_URLS = [
  "http://192.168.100.77:3001", // Your current IP
...
export default function UserReports() {
  ...
  try {
    ...
    // ✅ FIXED: Send only the status field that the backend expects
    const updateData = { 
      status: newStatus 
    };

    const response = await fetch(`${workingAPI}/api/reports/${reportId}/status`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
